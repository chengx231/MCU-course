...
**使用慣性元件量測ESP32即時角度以 AHRS座標表示，並運用程式模擬以飛機圖形即時顯示**
# 系統方塊圖
![](https://raw.githubusercontent.com/chengx231/MCU-course/e3b51c2d2f2e180433c092bd1a142c773198a00c/images/MPU6050.jpg)
## 使用元件
* MPU6050
* ESP32
## 使用軟體
...
#code
revised from arduino exampples
```
